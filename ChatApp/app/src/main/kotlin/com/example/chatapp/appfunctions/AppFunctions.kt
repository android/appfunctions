...
class AppFunctions
    ...
    constructor(
         ...
         *
         * Required workflow: Call "searchContacts" first to obtain the correct "endpointValue".
         *
         * @param appFunctionContext The context of this app function call.
         ...
         *
         * Required workflow: Call "searchContacts" first to obtain the "endpointValue" for accuracy.
         *
         * @param appFunctionContext The context of this app function call.
